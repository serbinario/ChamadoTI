...
class ListaService
{
    ...
    /**
     * @param ListaRepository $repository
     */
     ...
     * @return array
     */
    public function store(array $data) : Lista
    {
        
        $data = $this->tratamentoCampos($data);
        
        $lista =  $this->repository->create($data);
     ...
     * @return mixed
     */
    public function update(array $data, int $id) : Lista
    {

        $data = $this->tratamentoCampos($data);

        #Atualizando no banco de dados
        $lista = $this->repository->update($data, $id);
