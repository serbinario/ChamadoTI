...
use Serbinario\Services\FornecedorService;
...
class FornecedorController extends Controller
{
    ...
    */
    ...
    /**
    * @param FornecedorService $service
    * @param FornecedorValidator $validator
    */
    public function __construct(FornecedorService $service, FornecedorValidator $validator)
    {
    ...
    public function create()
    {
        ...
        #Retorno para view
        return view('fornecedor.create', compact('loadFields'));
    }
    ...
    public function edit($id)
    {
        try {
            ...
            #retorno para view
            return view('fornecedor.edit', compact('model', 'loadFields'));
