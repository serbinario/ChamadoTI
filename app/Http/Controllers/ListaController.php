...
use Serbinario\Services\ListaService;
...
class ListaController extends Controller
{
    ...
    * @param ListaValidator $validator
    */
    public function __construct(ListaService $service, ListaValidator $validator)
    {
    ...
    public function create()
    {
        ...
        #Retorno para view
        return view('lista.create', compact('loadFields'));
    }
    ...
    public function edit($id)
    {
        try {
            ...
            #retorno para view
            return view('lista.edit', compact('model', 'loadFields'));
