...
@section('content')
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            ...
            {!! Form::model($model, ['route'=> ['serbinario.fornecedor.update', $model->id], 'id' => 'formFornecedor', 'enctype' => 'multipart/form-data']) !!}
                @include('tamplatesForms.tamplateFormFornecedor')
...
//echo $cliente['enderecosEnderecos']['bairrosBairros']['cidadesCidades']['estadosEstados']['id']; ?>
    @section('javascript')
        <script src="{{ asset('/js/validacoes/validation_form_fornecedor.js') }}"></script>
