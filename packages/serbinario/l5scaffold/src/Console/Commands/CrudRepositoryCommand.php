...
class CrudRepositoryCommand extends Command
{
    ...
    protected function SetRepository($modelName){
        ...
        $this->buildRepository .= "\t\t\t\\Serbinario\\Repositories\\" . Inflector::singularize($modelName)  . "Repository::class,\n";
        $this->buildRepository .= "\t\t\t\\Serbinario\\Repositories\\" . Inflector::singularize($modelName) . "RepositoryEloquent::class\n";
